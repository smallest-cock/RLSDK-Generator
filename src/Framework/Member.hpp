...
enum class EMemberTypes : uint8_t
{
	...
	UProperty_Flags,
	UProperty_Offset,
	UStruct_SuperField, // Not needed if SuperField is in the UField class, comment out "SUPERFIELDS_IN_UFIELD" in your "GameDefines.hpp"
	                    // file!
	UStruct_Children,
	UStruct_Size,
	UStruct_Alignment,
...
public:                                                  // Global Utils
	...
	static size_t      GetClassOffset(EClassTypes type); // Returns the start offset of the given type, taking into account its inherited
	                                                     // classes.
