...
enum EClassFlags : uint32_t
{
	...
	CLASS_Inherit = (CLASS_Transient | CLASS_Config | CLASS_Localized | CLASS_SafeReplace | CLASS_PerObjectConfig |
	                 ...
	                 CLASS_IsAUStructProperty | CLASS_IsAUState | CLASS_IsAUFunction | CLASS_HasComponents | CLASS_Deprecated |
	                 CLASS_Intrinsic | CLASS_HasInstancedProps | CLASS_HasCrossLevelRefs),
...
// Comment this out if "SuperField" is located in UStruct instead of UField!
// #define SUPERFIELDS_IN_UFIELD

// Uncommenting this will disable using the "MinAlignment" field in UStruct, it is recommended you keep this commented.
...
public:
	...
	int32_t Offset;							REGISTER_MEMBER(int32_t, Offset, EMemberTypes::UProperty_Offset)					// 0x0060 (0x04)
