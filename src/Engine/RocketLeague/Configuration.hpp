...
enum EAlignment : int32_t { NONE = 0x1, X32BIT = 0x4, X64BIT = 0x8 };
...
private:                                 // Generator Settings
	static bool        m_addPchIfdefs;   // custom addon
	static std::string m_pchName;        // custom addon
	static std::string m_pchMacroName;   // custom addon
	static bool        m_addConstIfdefs; // custom addon
...
public:
	static bool        addPchIfdefs() { return m_addPchIfdefs; } // custom addon
	static std::string getPchIfdefs() { return std::format("#ifdef {}\n#include \"{}\"\n#endif\n\n", m_pchMacroName, m_pchName); }
	static bool        addConstIfdefs() { return m_addConstIfdefs; } // custom addon
